...
export default function MyPosts() {
  ...
  const getPosts = api.post.getAllFromUser.useInfiniteQuery(
    ...
    {
      enabled: !!user?.id, getNextPageParam: (lastPage, allPages) => {
      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        <div className="flex flex-col gap-2 w-3/4 mt-8">
          ...
          <Pagination>
            <PaginationContent>
              <PaginationItem>
                <PaginationPrevious data-disabled={page === 1} className="data-[disabled=true]:cursor-not-allowed" onClick={async () => {
                  if (page > 1) {
                    setPage(old => old - 1);
              ...
              <PaginationItem>
                <PaginationNext data-disabled={!getPosts.hasNextPage} className="data-[disabled=true]:cursor-not-allowed" onClick={async () => {
